...
/**
 * Create Linear B Prediction
 */
export const predictionCreateLinearBPrediction = <
  ThrowOnError extends boolean = false,
>(
  options: Options<PredictionCreateLinearBpredictionData, ThrowOnError>,
) => {
  return (options?.client ?? client).post<
    PredictionCreateLinearBpredictionResponse,
    PredictionCreateLinearBpredictionError,
  ...
  >({
    ...options,
    url: "/api/v1/prediction/linear-b/",
  });
};

/**
 * Create Mhc I Prediction
 */
export const predictionCreateMhcIPrediction = <
  ThrowOnError extends boolean = false,
>(
  options: Options<PredictionCreateMhcIpredictionData, ThrowOnError>,
) => {
  return (options?.client ?? client).post<
    PredictionCreateMhcIpredictionResponse,
    PredictionCreateMhcIpredictionError,
  ...
  >({
    ...options,
    url: "/api/v1/prediction/mhc-i/",
  });
};

/**
 * Create Mhc Ii Prediction
 */
export const predictionCreateMhcIiPrediction = <
  ThrowOnError extends boolean = false,
>(
  options: Options<PredictionCreateMhcIiPredictionData, ThrowOnError>,
) => {
  return (options?.client ?? client).post<
    PredictionCreateMhcIiPredictionResponse,
    PredictionCreateMhcIiPredictionError,
