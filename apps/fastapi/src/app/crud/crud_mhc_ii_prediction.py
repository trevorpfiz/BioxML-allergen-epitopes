...
from app.schemas.mhc_ii_prediction import (
    MhcIIPrediction,
    MhcIIPredictionCreate,
    MhcIIPredictionResult,
    MhcIIPredictionUpdate,
)


class CRUDMhcIIPrediction(
    CRUDBase[
        MhcIIPrediction,
        MhcIIPredictionCreate,
        MhcIIPredictionUpdate,
    ...
    async def create(
        self, db: AsyncClient, *, obj_in: MhcIIPredictionCreate, user: UserIn
    ) -> MhcIIPrediction:
...
# Instantiate the CRUDMhcIIPrediction object
crud_mhc_ii_prediction = CRUDMhcIIPrediction(MhcIIPrediction)
